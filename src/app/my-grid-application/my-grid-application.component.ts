...
private gridOptions: GridOptions;
  ...
  constructor() {
    ...
    this.gridOptions.columnDefs=[
      ...
      {headerName: "Country", field: "country", cellRendererFramework: RedComponentComponent, width: 120},
